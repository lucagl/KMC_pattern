...
/*TODO 
Empty attachment class befre entering parallel region
make attachment class local and combine it externally as diffusion
Transform diffusion class in a vector rather than a list.. 
Maybe try transforming all classes in vectors.
Redesign parallel region with random access..
*/
    ...
    {   
        ...
        #pragma omp for schedule (static) nowait
            for (int i = 0; i < Diff_adatoms.size(); i++){
                // I CAN PARALLEL LOOP ONLY ON RANDOM ACCESS ITERATORS, that's why I keep loop over index (is equivalent)
